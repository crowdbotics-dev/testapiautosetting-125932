...
## Project Structure
    ...
    ├── testapiautosetting_125932  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125932`
...
2. Clone this repo and `cd testapiautosetting_125932`
